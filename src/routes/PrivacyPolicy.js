  ...
  return (
    <>
      <div className="privacy-policy-content">
        <div className="privacy-policy-heading-button-group">
        ...
        <h3 className="privacy-policy-subheading">Interpretation</h3>
        <p>
        ...
        <h3 className="privacy-policy-subheading">Definitions</h3>
        ...
        <h3 className="privacy-policy-subheading">Types of Data Collected</h3>
        <h4>Personal Data</h4>
        <p>
        ...
        <h3 className="privacy-policy-subheading">Use of Your Personal Data</h3>
