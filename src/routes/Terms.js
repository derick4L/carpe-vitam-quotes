...
const Terms = () => {
  ...
  useEffect(() => {
    setDocTitle((document.title = "Terms | Quotes To Inspire & Share"));
  }, [docTitle]);

  return (
    <>
      <div className="terms-content">
        <div className="terms-heading-button-group">
          <h2 className="terms-heading">Terms & Conditions</h2>
          <Button className="terms-button" onClick={() => navigate("/")}>
            Back
          </Button>
        </div>
        ...
        <h2 className="terms-heading">Interpretation and Definitions</h2>
        ...
        <h2 className="terms-heading">Definitions</h2>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Carpe Vitam Quotes.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Carpe Vitam Quotes, accessible
              from{" "}
              <a
        ...
        <h2 className="terms-heading">Acknowledgment</h2>
        <p>
        ...
        <h2 className="terms-heading">Content</h2>
        <h3 className="terms-subheading">Your Right to Post Content</h3>
        <p>
        ...
        <h3 className="terms-subheading">Content Restrictions</h3>
        <p>
        ...
        <h3 className="terms-subheading">Content Backups</h3>
        <p>
        ...
        <h2 className="terms-heading">Copyright Policy</h2>
        <h3 className="terms-subheading">Intellectual Property Infringement</h3>
        <p>
        ...
        <p>
          ...
          our copyright agent via email at support@carpevitamquotes.com and
        ...
        <p>
          ...
          support@carpevitamquotes.com. Upon receipt of a notification, the
        ...
        <h3 className="terms-subheading">Links to Other Websites</h3>
        <p>
        ...
        <h3 className="terms-subheading">Termination</h3>
        <p>
        ...
        <h3 className="terms-subheading">Disputes Resolution</h3>
        <p>
          If You have any concern or dispute about the Service, You agree to
          first try to resolve the dispute informally by contacting the Company.
        </p>
        <h3 className="terms-subheading">For European Union (EU) Users</h3>
        <p>
          If You are a European Union consumer, you will benefit from any
          mandatory provisions of the law of the country in which you are
          resident in.
        </p>
        <h3 className="terms-subheading">United States Legal Compliance</h3>
        <p>
        ...
        <h2 className="terms-heading">Severability and Waiver</h2>
        ...
        <h3 className="terms-subheading">Waiver</h3>
        <p>
        ...
        <h3 className="terms-subheading">Translation Interpretation</h3>
        <p>
        ...
        <ul>
          <li>By email: support@carpevitamquotes.com</li>
        </ul>
      </div>
    </>
  );
